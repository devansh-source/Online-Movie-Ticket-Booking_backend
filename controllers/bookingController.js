...
const createBooking = asyncHandler(async (req, res) => {
    ...
    // Check total capacity limit (optional: ensures requested seats don't exceed total capacity)
    if (existingBookedSeats.length + seatsToBook.size > showtime.capacity) {
        res.status(400);
